...
RUN \
  ...
  git clone https://github.com/WOW-Docker/server.git /sources --recursive -b master && \
  git clone https://github.com/WOW-Docker/database.git /database --recursive -b master && \
  git clone https://github.com/WOW-Docker/MangosZero.git /install --recursive -b master
